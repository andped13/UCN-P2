...
\newline
Deruover har UCN boardet to UART pins (hardware serial ports). Disse har gruppen valgt at anvende under test af ADC\ref{ref_adc}\fxnote{ret reference til adc afsnit} for at verificere at ADC'en virker efter hensigten. 
